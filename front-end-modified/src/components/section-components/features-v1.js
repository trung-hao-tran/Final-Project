			      ...
			      <div className="col-lg-4 col-sm-6 col-12">
			        <div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
			          ...
			          <div className="ltn__feature-info">
			            <h3><Link to="/service-details">Post A Task</Link></h3>
							<p> Tell others your task requirements and see if anyone is willing to take over your task and solve your troubles! </p>
							<Link className="ltn__service-btn" to="/service-details">Post A Task <i className="flaticon-right-arrow" /></Link>
			          </div>
			        </div>
			      </div>
			      <div className="col-lg-4 col-sm-6 col-12">
			        <div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1 active">
			          ...
			          <div className="ltn__feature-info">
							<h3><Link to="/shop-left-sidebar">Find A Task</Link></h3>
							<p>If you want to see if there are any tasks you are interested in and learn about them, come here and take a look!</p>
							<Link className="ltn__service-btn" to="/shop-left-sidebar">Find A Task <i className="flaticon-right-arrow" /></Link>
			          </div>
			        </div>
			      </div>
			      <div className="col-lg-4 col-sm-6 col-12">
			        <div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
			          ...
			          <div className="ltn__feature-info">
			            <h3><Link to="/service-details">Take A Task</Link></h3>
							<p>Are you ready to solve problems for others and get paid, come and start your mission!</p>
							<Link className="ltn__service-btn" to="/service-details">Take A Task <i className="flaticon-right-arrow" /></Link>
			          </div>
			        </div>
			      </div>
			    </div>
