...
class ShopGridV1 extends Component {
	...
	componentDidMount() {
		console.log('componentDidMount is called12313213212');
		// http request
		fetch('/api/tasks')
			.then((response) => {
				if (!response.ok) {
				...
				console.log('Data received:99999', response);
				return response.text();
			})
			.then((data) => {
				const jsonData = JSON.parse(data); // jason parse
				console.log('Data received:1', jsonData);
				this.setState({ tasks: jsonData });
				console.log('Data received:2', jsonData);
			})
			.catch((error) => {
								...
								<div className="tab-content">
									<div className="tab-pane fade active show" id="liton_product_grid">
										<div className="ltn__product-tab-content-inner ltn__product-grid-view">
											...
											{/* ltn__product-item */}
											{tasks.map((task) => (
												<div className="col-xl-6 col-sm-6 col-12" key={task._id}>
													<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
														...
														<div className="product-info">
															...
															<h2 className="product-title go-top"><Link to={`/task-details/${task._id}`}>{task.title}</Link></h2>
															<div className="product-img-location go-top">
																<ul>
																	<li>
																		<Link to="/contact"><i className="flaticon-pin" /> {task.location}</Link>
																	</li>
																</ul>
															</div>
														...
														<div className="product-info-bottom">
															<div className="product-price">
																<span>{task.frequency}<label>/hours</label></span>
															</div>
														</div>
													</div>
												</div>
													...
													<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5">
														...
														<div className="product-info">
															<div className="product-badge-price">
																<div className="product-badge">
																	<ul>
																		<li className="sale-badg">Active1234</li>
																	</ul>
																</div>
																<div className="product-price">
																	<span>$9999<label>/Hours</label></span>
																</div>
															</div>
															<h2 className="product-title go-top"><Link to="/product-details">Task Title</Link></h2>
															<div className="product-img-location go-top">
																<ul>
																	<li>
																		<Link to="/contact"><i className="flaticon-pin" /> Kingsford, Sydney, NSW</Link>
																	</li>
																</ul>
															</div>
															<ul className="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
																<li>Some bref introduction
																</li>
															</ul>
														</div>
														<div className="product-info-bottom">
															<div className="real-estate-agent">
																...
																<div className="agent-brief">
																	<h6><Link to="/team-details">User name</Link></h6>
																	<small>Score/Quote</small>
																</div>
															</div>
															<div className="product-hover-action">
																<ul>
													...
													<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5">
														...
														<div className="product-info">
															<div className="product-badge-price">
																<div className="product-badge">
																	<ul>
																		<li className="sale-badg">Active</li>
																	</ul>
																</div>
																<div className="product-price">
																	<span>$9999<label>/Hours</label></span>
						...
						<div className="ltn__quick-view-modal-inner">
							...
							<div className="row">
								...
								<div className="modal-product-info go-top">
									<h5><Link to="/product-details">Task Title</Link></h5>
