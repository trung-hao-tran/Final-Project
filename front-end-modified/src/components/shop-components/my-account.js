									...
									<div className="col-lg-4">
										<div className="ltn__tab-menu-list mb-50">
											<div className="nav">
												...
												<a data-bs-toggle="tab" href="#ltn_tab_1_4">Profiles <i className="fas fa-user" /></a>
												<a data-bs-toggle="tab" href="#ltn_tab_1_5">My Task <i className="fa-solid fa-list" /></a>
												<a data-bs-toggle="tab" href="#ltn_tab_1_6">Current Task <i className="fa-solid fa-briefcase" /></a>
												<a href="">Logout <i className="fas fa-sign-out-alt" /></a>
											</div>
										</div>
									</div>
										...
										<div className="tab-content">
											<div className="tab-pane fade active show" id="ltn_tab_1_1">
												<div className="ltn__myaccount-tab-content-inner">
													...
													<p>From your account dashboard you can view your <span>recent tasks</span> and <span>edit your password and account details</span>.</p>
												</div>
											</div>
																	...
																	<ul>
																		<li>
																			...
																			<div className="footer-address-info">
																				<p>Kensington, New South Wales, Australia</p>
																			</div>
																		</li>
																		<li>
																			<div className="footer-address-icon">
																		...
																		<li>
																			...
																			<div className="footer-address-info">
																				<p><a href="mailto:trunghao2000@gmail.com">trunghao2000@gmail.com</a></p>
																			</div>
																		</li>
																	</ul>
																</div>
														...
														<form action="#">
															<div className="row mb-50">
																...
																<div className="col-md-6">
																	...
																	<input type="text" name="ltn__lastname" placeholder="Kensington" />
																</div>
																<div className="col-md-6">
																	<label>Display Email:</label>
																	<input type="email" name="ltn__lastname" placeholder="trunghao2000@gmail.com" />
																</div>
															</div>
															<fieldset>
																...
																<tr>
																	...
																	<td>
																		<div className="ltn__my-properties-info">
																			<h6 className="mb-10 go-top"><Link to="/product-details">New Task</Link></h6>
																			<small><i className="icon-placeholder" /> Kensington, NSW, Australia</small>
